...
import com.company.constants.MovieGenre;
import com.company.constants.UserType;
...
public class DataStore {
    ...
    private static Bookmark[][] bookmarks = new Bookmarks[BOOKMARK_TYPES_COUNT][BOOKMARK_COUNT_PER_TYPE];
    ...
    private static void loadUsers(){
        users[0]= UserManager.getInstance().createUser(1000, "user0@semanticsquare.com",	"test",	"John",	"M", Gender.MALE, UserTye.USER);
        users[1]= UserManager.getInstance().createUser(1001, "user0@semanticsquare.com",	"test",	"Sam",	"M", Gender.MALE, UserTye.USER	);
        users[2]= UserManager.getInstance().createUser(1002, "user0@semanticsquare.com",	"test",	"Anita",	"M", Gender.MALE, UserTye.EDITOR);
        users[3]= UserManager.getInstance().createUser(1003, "user0@semanticsquare.com",	"test",	"Sara",	"M", Gender.FEMALE , UserTye.EDITOR);
        users[4]= UserManager.getInstance().createUser(1004, "user0@semanticsquare.com",	"test",	"Dheeru",	"M", Gender.MALE, UserTye.CHIEFEDITOR);
    }
    ...
    private static void loadMovies(){
        ...
        bookmarks[1][1]=BookmarkManager.getInstance().createMovie(3001,"The Grapes of Wrath","",1940,new String[] {"Fonda","Jane Darwell"},new String[]{"Ford"},MovieGenre.CLASSICS,8.2);
